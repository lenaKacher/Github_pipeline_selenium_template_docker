...
import de.jenkins.advantageshop.pageobjects.*;
...
public class TestAddSpeakerToCart extends TestBase {
    ...
    public ArrayList<String> getSpeakerResults1() {
        ArrayList<String> aListOfResults = new ArrayList<>();
